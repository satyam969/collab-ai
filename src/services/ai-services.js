...
const model = genAI.getGenerativeModel({
    ...
    user:Create an express application 
       ...
       IMPORTANT: DONOT GENERATE ANY THING LIKE test: 'Removed buildCommand and startCommand from the fileTree' in the filetree 
IMPORTANT : always handle errors if they are present in the filetree generated by user or you confirm that errors like this doesnot arise:-Unexpected non-whitespace character after JSON at position 2156 (line 1 column 2157)
